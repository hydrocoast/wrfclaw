...
! pressure fields based on data files
!
! ==============================================================================
...
contains
    ...
    subroutine read_wrf_storm(storm,t)
        ...
        data_path = trim(storm%data_path_root) // "u10_d01.swt"
        ...
        data_path = trim(storm%data_path_root) // "v10_d01.swt"
        ...
        ! Read pressure file
        data_path = trim(storm%data_path_root) // "slp_d01.swt"
